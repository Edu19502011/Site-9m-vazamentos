...
export default function Seguranca() {
  return (
    <PanelLayout>
      ...
      >
        <h2 className="text-2xl font-bold text-fuchsia-200 mb-2">Proteja sua conta e servidor</h2>
        <p className="text-fuchsia-100 text-center text-lg mb-4">
          Ative autenticação em dois fatores, revise acessos e configure alertas para garantir máxima segurança.
        </p>
