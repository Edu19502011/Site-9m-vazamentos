...
export default function Tickets() {
  return (
    <PanelLayout>
      ...
      >
        <h2 className="text-2xl font-bold text-fuchsia-200 mb-2">Precisa de ajuda?</h2>
        <p className="text-fuchsia-100 text-center text-lg mb-4">
          Abra um ticket para suporte, dúvidas ou solicitações. Nossa equipe responde rápido e com prioridade para membros premium!
        </p>
