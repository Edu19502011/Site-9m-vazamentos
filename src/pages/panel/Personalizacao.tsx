...
export default function Personalizacao() {
  return (
    <PanelLayout>
      ...
      >
        <h2 className="text-2xl font-bold text-fuchsia-200 mb-2">Customize o painel e o bot</h2>
        <p className="text-fuchsia-100 text-center text-lg mb-4">
          Altere cores, temas, ícones, comandos e deixe tudo com a cara do seu servidor.
        </p>
