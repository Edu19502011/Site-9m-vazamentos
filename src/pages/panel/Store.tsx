...
export default function Store() {
  return (
    <PanelLayout>
      ...
      >
        <h2 className="text-2xl font-bold text-fuchsia-200 mb-2">Compre ferramentas exclusivas!</h2>
        <p className="text-fuchsia-100 text-center text-lg mb-4">
          Adquira bots, automações e recursos premium para seu servidor Discord com segurança e suporte dedicado.
        </p>
