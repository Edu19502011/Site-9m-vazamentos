...
export default function Preferencias() {
  return (
    <PanelLayout>
      ...
      >
        <h2 className="text-2xl font-bold text-fuchsia-200 mb-2">Personalize sua experiência</h2>
        <p className="text-fuchsia-100 text-center text-lg mb-4">
          Ajuste preferências de notificações, temas, integrações e muito mais para deixar o painel do seu jeito.
        </p>
