...
export default function Pagamentos() {
  return (
    <PanelLayout>
      ...
      >
        <h2 className="text-2xl font-bold text-fuchsia-200 mb-2">Gerencie seus pagamentos</h2>
        <p className="text-fuchsia-100 text-center text-lg mb-4">
          Veja histórico de pagamentos, renove planos e acesse recibos de forma rápida e segura.
        </p>
